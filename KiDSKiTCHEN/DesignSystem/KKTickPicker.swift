...
//  KiDSKiTCHEN
//
//  Analoger Strich-Picker (Mengen-Eingabe). Übernommen aus Kavsoft
//  „TickPickerView" von Balaji Venkatesh (21/12/25) — nur Preview an KK
//  angepasst, Logik unverändert. Quelle: ~/z/Agents/Claude/xCode/kavsoft/
//  TickPickerView.
//
...
#Preview {
    @Previewable @State var value = 40
    return VStack {
        Text("\(value)")
        TickPicker(count: 100, selection: $value)
    }
    .padding()
}
